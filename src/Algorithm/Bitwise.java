...
/**
 * Algorithm.Bitwise.java    :    This class is created for bitwise calculator
...
public class Bitwise {
    ...
    public void generateInterface() {
        ...
        System.out.println("********** Algorithm.Bitwise **********");
    ...
    /**
     * The Algorithm.Bitwise operator AND method of integer a and b
   ...
   public int AND(int a, int b){
    ...
    /**
     * The Algorithm.Bitwise operator OR method of integer a and b
     * @param a first Input parameter of value a
     * @param b second of value b
   ...
   public int OR(int a, int b){
    ...
    /**
     * The Algorithm.Bitwise operator XOR method of integer a and b
     * @param a first Input parameter of value a
     * @param b second of value b
   ...
   public int XOR(int a, int b){
    ...
    /**
     * The Algorithm.Bitwise operator leftShift method of integer a and b
     * @param a first Input parameter of value a
     * @param b second of value b
   ...
   public int leftShift(int a, int b){
    ...
    /**
     * The Algorithm.Bitwise operator rightShift method of integer a and b
     * @param a first Input parameter of value a
     * @param b second of value b
    ...
    /**
     * The Algorithm.Bitwise operator bitInversion method of integer a and b
     * @param a first Input parameter of value a
